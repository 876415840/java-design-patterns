package com.alan.factory.method;

import com.alan.factory.method.domain.AbstractFactory;
import com.alan.factory.method.domain.Product;
...
public class App {
    ...
    public App() {
        String[] classNames = new String[]{"com.alan.factory.method.domain.ConcreteFactory1", "com.alan.factory.method.domain.ConcreteFactory2"};
