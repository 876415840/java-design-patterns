package com.alan.model.gof23.behavior.memento;

import com.alan.model.gof23.behavior.memento.domain.Caretaker;
import com.alan.model.gof23.behavior.memento.domain.Originator;
...
public class App {
    ...
    public App() {
        ...
        or.setState("S0");
        LOGGER.info("初始状态:{}", or.getState());
        // 保存初始状态
        cr.setMemento(or.createMemento());
        // 修改状态
        or.setState("S1");
        LOGGER.info("新的状态:{}", or.getState());
        // 恢复状态
        or.restoreMemento(cr.getMemento());
        LOGGER.info("恢复状态:{}", or.getState());
    }
